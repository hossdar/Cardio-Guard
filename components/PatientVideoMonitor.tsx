...
const PatientVideoMonitor: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full w-full items-center justify-start">
        ...
        */}
        <div 
            className="relative w-full max-w-md bg-black rounded-3xl overflow-hidden shadow-lg ring-1 ring-black/10 z-10 flex-shrink-0"
            style={{ aspectRatio: '1/1' }}
        >
            {error ? (
                <div className="absolute inset-0 flex flex-col items-center justify-center bg-gray-900 text-gray-400 p-6 text-center">
